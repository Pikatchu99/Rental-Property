...
class NearestStationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nearest_station" do
    assert_difference('NearestStation.count') do
      post nearest_stations_url, params: { nearest_station: { how_many_minutes_walk: @nearest_station.how_many_minutes_walk, name_of_railway: @nearest_station.name_of_railway, station_name: @nearest_station.station_name } }
    end
  ...
  test "should update nearest_station" do
    patch nearest_station_url(@nearest_station), params: { nearest_station: { how_many_minutes_walk: @nearest_station.how_many_minutes_walk, name_of_railway: @nearest_station.name_of_railway, station_name: @nearest_station.station_name } }
